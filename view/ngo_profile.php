...
<div class="thumb-content">
  <div class="card shadow-sm mb-2">
    <div class="card-body d-flex justify-content-start align-items-center mx-4">
      ...
      <div class="d-flex flex-column justify-content-center align-items-center">
        <div class="mb-2" style="width:120%; font-size: 170%; text-align: center; padding-left: 90px"><b>NGO ID: </b><?php echo $id ?></div>
      </div>
    </div>
  </div>
  ...
  <div class="card shadow-sm mb-2">
    <div class="card-body d-flex justify-content-start align-items-center mx-4">
      ...
      <div class="d-flex flex-column justify-content-center align-items-center">
        <div class="mb-2" style="width:120%; font-size: 170%; text-align: center; padding-left: 90px"><b>NGO NAME: </b><?php echo $name ?></div>
      </div>
    </div>
  </div>
